...
public class Client {
	...
	public String[] getNOrders(String[] creds, int nOrders) {  //TODO: Return as 2d array {{CODE,STR},{ORDER SHIT},{ORDER SHIT}...}
		XmlRpcClient server = createConnection();
		...
		try {
			Object result = server.execute("server.getNOrders", params);
			String res = result.toString();
			return strToArray(res);
		}
		catch (Exception ex) { System.err.println(ex.getMessage()); return new String[] {"-20","Connection Error!"}; }
